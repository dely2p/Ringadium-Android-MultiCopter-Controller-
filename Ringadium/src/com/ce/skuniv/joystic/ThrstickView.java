...
public class ThrstickView extends View {
	...
	private ThrstickMovedListener moveListener;
	private ThrstickClickedListener clickListener;
	...
	public ThrstickView(Context context) {
		super(context);
		initThrstickView();
	}

	public ThrstickView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initThrstickView();
	}

	public ThrstickView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initThrstickView() {
		setFocusable(true);

//		ImageView  iv= (ImageView)findViewById(R.id.joystickView);
...
*/
	...
	public void setOnThrstickMovedListener(ThrstickMovedListener listener) {
		this.moveListener = listener;
	}
	
	public void setOnThrstickClickedListener(ThrstickClickedListener listener) {
