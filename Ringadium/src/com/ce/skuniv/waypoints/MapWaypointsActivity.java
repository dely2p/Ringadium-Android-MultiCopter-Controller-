package com.ce.skuniv.waypoints;
...
public class MapWaypointsActivity extends SherlockFragmentActivity {
	...
	void DisplayInfo() {
		...
		TVInfoMap.append("Head:" + String.valueOf((int) app.mw.head) + "head" + "\n");
		...
		TVInfoMap.append("DirToHome:" + String.valueOf((int) app.mw.GPS_directionToHome + "home"));
